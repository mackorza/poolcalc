      ...
      <div className="max-w-7xl mx-auto px-4 py-12">
        <div className="flex justify-between items-center mb-8">
          <div>
            ...
            <p className="text-gray-600 mt-2">Browse all pool tournaments</p>
          </div>
          <Link
            href="/admin"
        ...
        {!tournaments || tournaments.length === 0 ? (
          <div className="bg-white rounded-lg shadow-lg p-12 text-center">
            ...
            <h2 className="text-2xl font-semibold text-gray-900 mb-2">No tournaments yet</h2>
                  ...
                  <div className="space-y-2 text-sm text-gray-600">
                    ...
                    <div className="flex gap-4 mt-4">
                      <div className="flex items-center gap-1">
                        <span className="font-semibold">{tournament.num_tables}</span>
                        <span className="text-xs text-gray-500">
                          {tournament.num_tables === 1 ? 'table' : 'tables'}
                        </span>
                      </div>
                      <div className="flex items-center gap-1">
                        <span className="font-semibold">{tournament.num_rounds}</span>
                        <span className="text-xs text-gray-500">
