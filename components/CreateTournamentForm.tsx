              ...
              <div>
                ...
                <div className="grid grid-cols-2 gap-3">
                  ...
                  >
                    ...
                    <p className="text-xs text-slate-400 ml-6">
                      Pool stage &rarr; Knockout playoffs
                    </p>
                  </button>
                </div>
                ...
                {playoffInfo && tournamentFormat === 'pool_playoff' && (
                  <div className="mt-3 p-3 bg-blue-900/30 rounded-lg border border-blue-700">
                    ...
                    <ul className="text-xs text-blue-200 space-y-1">
                      <li>&bull; {playoffInfo.numPools} pools of {playoffInfo.teamsPerPool} teams</li>
                      <li>&bull; Top {playoffInfo.teamsQualify} from each pool advance</li>
                      <li>&bull; Knockout: {playoffInfo.playoffStages.join(' \u2192 ')}</li>
                    </ul>
                  </div>
                )}
              </div>
